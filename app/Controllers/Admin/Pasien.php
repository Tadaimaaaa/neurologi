...
class Pasien extends BaseController
{
    ...
    /**
     * Daftar semua pasien, dengan fitur pencarian.
     */
    ...
    {
        return view('admin/pasien/form', ['title' => 'Tambah Pasien', 'pasien' => null]);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/admin/pasien')->with('success', "Pasien berhasil ditambahkan dengan No. RM: {$noRM}");
    }
    ...
    public function edit(int $id)
    {
        ...
        if (!$pasien) {
            return redirect()->to('/admin/pasien')->with('error', 'Data pasien tidak ditemukan.');
        }

        return view('admin/pasien/form', ['title' => 'Edit Pasien', 'pasien' => $pasien]);
    }
