...
<head>
    ...
    <style>
        .brand-link { background-color: #5f4bb6; border-bottom: 1px solid #4a3a9a; }
        .sidebar { background-color: #1e1a2e; }
        .sidebar .nav-sidebar .nav-item .nav-link { color: #ccc4e8; }
        .sidebar .nav-sidebar .nav-item .nav-link:hover { background-color: #2a243e; color: #ffffff; }
        .sidebar .nav-sidebar .nav-item .nav-link.active { background-color: #5f4bb6; color: #ffffff; }
        .nav-sidebar .nav-header { color: #9a8abf; font-size: 0.7rem; letter-spacing: 0.08em; }
    </style>
</head>
...
<div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                    ...
                    <span class="badge ms-1" style="background-color:#5f4bb6; font-size:0.65rem;">Perawat</span>
                </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1e1a2e;">
        <a href="<?= base_url('perawat/dashboard') ?>" class="brand-link">
            <i class="fas fa-user-nurse ms-3 me-2"></i>
            <span class="brand-text font-weight-bold" style="font-size: 0.9rem;">Portal Perawat</span>
        </a>
        <div class="sidebar">
            <nav class="mt-2">
