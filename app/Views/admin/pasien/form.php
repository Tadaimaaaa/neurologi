...
<div class="card card-outline card-success">
    ...
    <div class="card-body">
        <?php
            $action = $pasien
                ? base_url('admin/pasien/update/' . $pasien['id_pasien'])
                : base_url('admin/pasien/simpan');
        ?>
        <form action="<?= $action ?>" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nik" class="form-control" maxlength="16"
                               value="<?= old('nik', $pasien['nik'] ?? '') ?>" placeholder="16 digit NIK">
                    </div>
                    <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('admin/pasien') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
            </div>
        </form>
    </div>
</div>
